...
if (isset($_POST["save"])) {
  ...
  $select_image = $conn->prepare(
    "SELECT * FROM `posts` WHERE image = ? AND admin_id = ?"
  );
...
<section class="post-editor">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="title" maxlength="100" required placeholder="add post title" class="box" value="<?= $fetch_posts[
        "title"
      ] ?>">
      <p>post content <span>*</span></p>
      <textarea name="content" class="box" required maxlength="10000" placeholder="write your content..." cols="30" rows="10"><?= $fetch_posts[
        "content"
      ] ?></textarea>
