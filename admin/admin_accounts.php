...
if (isset($_POST["delete"])) {
  ...
  $delete_comments = $conn->prepare(
    "DELETE FROM `comments` WHERE admin_id = ?"
  );
      ...
      <div class="flex-btn">
         <?php if ($fetch_accounts["id"] == $admin_id) { ?>
            ...
            <form action="" method="POST">
               <input type="hidden" name="post_id" value="<?= $fetch_accounts[
                 "id"
               ] ?>" on>
